    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, automatically chunk the document and call Zep to build the knowledge graph, extract entities and relationships, and form temporal memory and community summaries.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph building is complete, please proceed to the next step to set up the simulation environment.</p>
          <button 
            class="action-btn" 
