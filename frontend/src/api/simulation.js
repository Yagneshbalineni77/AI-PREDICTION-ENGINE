...
/**
 * Prepare simulation environment (asyncTask）
...
/**
 * Real-time fetch of generatingSimulation Config
 * @param {string} simulationId
 * @returns {Promise} 返回Configuration信息，Contains元数据和ConfigurationContent
 */
...
/**
 * Get simulation run detailsStatus（Contains最近动作）
 * @param {string} simulationId
 */
...
/**
 * 获取History模拟List（带Project详情）
 * 用于首页HistoryProject展示
